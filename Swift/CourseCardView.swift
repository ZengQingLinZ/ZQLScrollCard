  ...
  @objc public var models: [String] = [String]() {
   ...
   @objc public var selectedCourseClosure: ((String) -> Void)?
    ...
    lazy fileprivate var collectionView: UICollectionView = {
        ...
        let collectionView = UICollectionView(frame: CGRect(x: xPadding, y: FIT_SCREEN_HEIGHT((self.frame.size.height-157)/2), width: SCREEN_WIDTH - xPadding * 2, height: FIT_SCREEN_HEIGHT(157)), collectionViewLayout: layout)
